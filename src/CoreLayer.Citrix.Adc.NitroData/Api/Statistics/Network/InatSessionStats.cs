...
namespace CoreLayer.Citrix.Adc.NitroData.Api.Statistics.Network
{
    public class InatSessionStats
    {
        ...
        [JsonPropertyName("gloabalinatcursessions")]public string GlobalInatCurrentSessions { get; set; }
        ...
        [JsonPropertyName("globalinatpktreceivedrate")]public double? GlobalIInatPacketReceivedRate { get; set; }
