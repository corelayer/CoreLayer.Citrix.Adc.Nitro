...
namespace CoreLayer.Citrix.Adc.NitroData.Api.Configuration.ContentSwitching
{
    public class CsvserverConfiguration : ICsvserverConfiguration
    {
        ...
        [JsonPropertyName("vipheader")]public string VirtualIpHeader { get; set; }
        ...
        [JsonPropertyName("authn401")]public string Authentication401 { get; set; }
        ...
        [JsonPropertyName("l2conn")]public string UseL2ParametersConnections { get; set; }
        ...
        [JsonPropertyName("icmpvsrresponse")]public string IcmpVsrResponse { get; set; }
        [JsonPropertyName("rhistate")]public string RouteHostInjectedState { get; set; }
