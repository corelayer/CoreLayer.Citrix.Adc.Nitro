...
{
    public abstract class LbvserverAddRequestData : INitroRequestData
    {
        public string Name { get; }
        public abstract string ServiceType { get; }

        public LbvserverAddRequestData(string lbvserverName)
        {
            Name = lbvserverName;
        }
        ...
        [JsonPropertyName("v6peristmasklen")]public double? V6PersistenceMaskLength { get; set; }
