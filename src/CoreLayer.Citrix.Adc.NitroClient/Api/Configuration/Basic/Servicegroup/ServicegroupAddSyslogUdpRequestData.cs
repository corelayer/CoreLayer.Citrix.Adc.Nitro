...
{
    public class ServicegroupAddSyslogUdpRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddSyslogUdpRequestData(string servicegroupName) : base(servicegroupName)
        { }
