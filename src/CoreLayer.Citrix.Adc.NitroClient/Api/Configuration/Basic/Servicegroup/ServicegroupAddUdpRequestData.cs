...
{
    public class ServicegroupAddUdpRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddUdpRequestData(string servicegroupName) : base(servicegroupName)
        {
        }
