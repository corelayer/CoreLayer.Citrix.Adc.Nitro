...
{
    public class ServicegroupAddSyslogTcpRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddSyslogTcpRequestData(string servicegroupName) : base(servicegroupName)
        {
        }
