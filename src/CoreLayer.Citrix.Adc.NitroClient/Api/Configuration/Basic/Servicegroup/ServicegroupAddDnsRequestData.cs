...
{
    public class ServicegroupAddDnsRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddDnsRequestData(string servicegroupName) : base(servicegroupName)
        {
        }
