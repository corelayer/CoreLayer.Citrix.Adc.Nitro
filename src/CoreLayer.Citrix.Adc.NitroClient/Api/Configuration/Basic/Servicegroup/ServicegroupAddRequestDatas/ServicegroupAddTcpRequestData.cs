...
{
    public class ServicegroupAddTcpRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddTcpRequestData(string servicegroupName) : base(servicegroupName)
        { }
