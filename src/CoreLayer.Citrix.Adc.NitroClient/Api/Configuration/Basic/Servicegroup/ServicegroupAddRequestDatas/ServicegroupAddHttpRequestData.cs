...
{
    public class ServicegroupAddHttpRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddHttpRequestData(string servicegroupName) : base(servicegroupName)
        { }
