...
{
    public class ServicegroupAddSslRequestData : ServicegroupAddRequestData
    {
        public ServicegroupAddSslRequestData(string servicegroupName) : base(servicegroupName)
        {
        }
