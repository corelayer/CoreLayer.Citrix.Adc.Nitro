...
{
    public class CsvserverAnalyticsProfileBindingAddCommand : NitroCommand<CsvserverAnalyticsProfileBindingAddResponse>
    {
        public CsvserverAnalyticsProfileBindingAddCommand(INitroServiceClient serviceClient, INitroRequestConfiguration requestConfiguration)
