...
{
    public class ServiceBindingRemoveScPolicyCommand : NitroCommand<ServiceBindingRemoveResponse>
    {
        public ServiceBindingRemoveScPolicyCommand(INitroServiceClient serviceClient,
