...
{
    public class ServiceBindingGetDosPolicyCommand : NitroCommand<ServiceBindingGetDosPolicyResponse>
    {
        public ServiceBindingGetDosPolicyCommand(INitroServiceClient serviceClient,
