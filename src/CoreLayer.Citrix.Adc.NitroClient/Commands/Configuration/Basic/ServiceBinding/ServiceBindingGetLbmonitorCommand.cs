...
{
    public class ServiceBindingGetLbmonitorCommand : NitroCommand<ServiceBindingGetLbmonitorResponse>
    {
        public ServiceBindingGetLbmonitorCommand(INitroServiceClient serviceClient,
