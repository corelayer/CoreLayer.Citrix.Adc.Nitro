        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return new object[]
            {
                ...
                new Dictionary<string, string>
                {
                    {"Method", "GET"},
                    {"ResourcePath", "/nitro/v1/config/lbvserver_servicegroup_binding"},
                    {"RequestUri", "/nitro/v1/config/lbvserver_servicegroup_binding?count=yes&attrs=Filter"},
            ...
            yield return new object[]
            {
                ...
                new Dictionary<string, string>
                {
                    {"Method", "GET"},
                    {"ResourcePath", "/nitro/v1/config/lbvserver_servicegroup_binding"},
                    {"RequestUri", "/nitro/v1/config/lbvserver_servicegroup_binding?attrs=Filter"},
