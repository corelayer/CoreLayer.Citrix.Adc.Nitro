...
+ Add:  
    * Properties:
        ...
        SupportIpv6Address| string | Support IPv6 addressing mode. If you configure a server with the IPv6 addressing mode, you cannot use the server in the IPv4 addressing mode. Default value: NO, Possible values = YES, NO | Domain only
        Comment| string | Information| All
        TrafficDomain| double| Integer value that uniquely identifies the traffic domain in which you want to configure the entity. If you do not specify an ID, the entity becomes part of the default traffic domain, which has an ID of 0. Minimum value = 0, Maximum value = 4094 | All
...
+ Get
    * Properties  
        ...
        TrafficDomain|string |Integer value that uniquely identifies the traffic domain in which you want to configure the entity. If you do not specify an ID, the entity becomes part of the default traffic domain, which has an ID of 0. Minimum value = 0. Maximum value = 4094
        AutoScale|string|Auto scale option for a servicegroup. Default value: DISABLED. Possible values = DISABLED, DNS, POLICY
        UseSourceIp|string| Use the client's IP address as the source IP address when initiating a connection to the server. Possible values = YES, NO
        ClientKeepAlive|string| Enable Client Keep-Alive. Possible Values = YES, NO.
        TcpBuffering|string|Enable TCP buffering. Possible Values = YES, NO.
        Compression|string| Enable Comperssion. Possible Values = YES, NO.
        ...
        SureConnect|string| State of the SureConnect Feature. Default value: OFF. Possible values = ON, OFF
        SurgeProtection|string | Enable Surge Protection. Default value: OFF. Possible values = ON, OFF
        ServerCfgFlags|string|-
        MaxReq|string|-
        MaxBandwidth|string|-
...
+ Add:  
    * Properties:
        ...
        MaxRequests|double|-|all
        Cacheable|string|-|HTTP, SSLBridge, SSL, SSLTCP, SYSLOG_TCP, SYSLOG_UDP, TCP, UDP
        InjectClientIp|string|-|all
        ClientIpHeader|string|-|all
        UseSourceIp|string|-|all
        PathMonitor|string|-|-
        PathMonitorIndv|string|-|-
        UseProxyPort|string|-|all
        SureConnect|string|-|HTTP, SSLBridge, SSL, SSLTCP, SYSLOG_TCP, SYSLOG_UDP, TCP, UDP
        SurgeProtection|string|-|HTTP, SSLBridge, SSL, SSLTCP, SYSLOG_TCP, SYSLOG_UDP, TCP, UDP, DNS_TCP
        RtspSessionIdRemap|string|-|-
        ClientTimeOut|double|-|all
        ServerTimeout|double|-|all
        CustomServerId|string|-|all
        ServerId|string|-|all
        ClientKeepAlive|string|-|all
        TcpBuffering|string|-|all
        Compression|string|-|HTTP, SSL
        MaxBandwidth|double|-|all
        AccessDown|string|-|all
        MonitorWeightThreshold|double|-|all
        State|string|-|all
        ...
        HashId|double|-|all
        Comment|string|-|all
        AppFlowLogging|string|-|all
        NetProfile|string|-|all
        TrafficDomain|double|TrafficDomain|all
        ProcessLocal|string|-|all
        MonitorConnectionClose|string|-|all
...
+ Get
    * Properties  
        ...
        MaxRequests|double|Maximum number of requests that can be sent on a persistent connection to the service. 
        ...
        InjectClientIp|string|Before forwarding a request to the service, insert an HTTP header with the client's IPv4 or IPv6 address as its value. Used if the server needs the client's IP address for security, accounting, or other purposes, and setting the Use Source IP parameter is not a viable option. Possible values = ENABLED, DISABLED
        ClientIpHeader|string|Name for the HTTP header whose value must be set to the IP address of the client. 
        UseSourceIp|string|Use the client's IP address as the source IP address when initiating a connection to the server. Possible values = YES, NO
        ...
        SureConnect|string|State of SureConnect for the service. Default value: OFF. Possible values = ON, OFF
        SurgeProtection|string|Enable surge protection for the service. Possible values = ON, OFF
        RtspSessionIdRemapping|string|Enable RTSP session ID mapping for the service. Default value: OFF. Possible values = ON, OFF
        ClientTimeout|double|Time, in seconds, after which to terminate an idle client connection.
        ServerTimeout|double|Time, in seconds, after which to terminate an idle server connection.
        ...
        ClientKeepAlive|string|Enable client keep-alive for the service. Possible values = YES, NO
        TcpBuffering|string|Enable TCP buffering for the service. Possible values = YES, NO
        Compression|string|Enable compression for the service. Possible values = YES, NO
        ...
        AppFlowLogging|string|Enable logging of AppFlow information. Default value: ENABLED. Possible values = ENABLED, DISABLED
        ...
        MonitorConnectionClose|string|Close monitoring connections by sending the service a connection termination message with the specified bit set. Default value: NONE. Possible values = RESET, FIN
        RiseApbrStatusMessageCode|int|The code indicating the rise apbr status.
        ...
        NumberOfConnections|int|This will tell the number of client side connections are still open.
        PolicyName|string|The name of the policyname for which this service is bound.
        ServiceConfigurationType|bool|The configuration type of the service.
        ServiceConfigurationType2|string|The configuration type of the service (Internal/Dynamic/Configured). Possible values = Configured, Dynamic, Internal
        ...
        DublicateState|string|Added this field for getting state value from table. Possible values = ENABLED, DISABLED
        DublicateWeight|string|-
        PublicIp|string|public ip.
        PublicPort|int|public port.
        ServerState|string|The state of the service. Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED
        ...
        MonitorStatCode|int|The code indicating the monitor response.
        LastResponse|string|The string form of monstatcode.
        ResponseTime|string|Response time of this monitor.
        RiseApbrStatusMessageCode2|int|The code indicating other rise stats.
        MonitorStatParameter1|int|First parameter for use with message code.
        MonitorStatParameter2|int|Second parameter for use with message code.
        MonitorStatParameter3|int|Third parameter for use with message code.
        ...
        MonitorView|string|Tells the mon owner of the service.
        MonitorOwner|string|Tells the view id of the monitoring owner.
        ServiceIp|string|This field has been intorduced to show the dbs services ip.
        ...
        Passive|bool|-
        MonitorUserStatusMessage|string|-
        Count|double|-
...
+ Add:  
    * Properties:
        ...
        ---|---|---
        Name|string|name of the service
        MonitorName|string|name of the monitor to bind.
        MonitorState|string|The configured state (enable/disable) of the monitor on this server. Possible values = ENABLED, DISABLED
...
+ Add:  
    * Properties:
        ...
        MaxRequests|double|Maximum number of requests that can be sent on a persistent connection to the service group. Note: Connection requests beyond this value are rejected.
        ...
        InjectClientIp|string|Insert the Client IP header in requests forwarded to the service. Possible values = ENABLED, DISABLED
        ClientIpHeader|string|Name of the HTTP header whose value must be set to the IP address of the client. Used with the Client IP parameter. If client IP insertion is enabled, and the client IP header is not specified, the value of Client IP Header parameter or the value set by the set ns config command is used as client's IP header name.
        UseSourceIp|string|Use client's IP address as the source IP address when initiating connection to the server. With the NO setting, which is the default, a mapped IP (MIP) address or subnet IP (SNIP) address is used as the source IP address to initiate server side connections. Possible values = YES, NO
        PathMonitor|string|Path monitoring for clustering. Possible values = YES, NO
        ...
        SureConnect|string|State of the SureConnect feature for the service group. Default value: OFF. Possible values = ON, OFF
        SurgeProtection|string|Enable surge protection for the service group. Default value: OFF. Possible values = ON, OFF
        RtspSessionIdRemap|string|Enable RTSP session ID mapping for the service group. Default value: OFF. Possible values = ON, OFF
        ClientTimeout|double|Time, in seconds, after which to terminate an idle client connection.
        ServerTimeout|double|Time, in seconds, after which to terminate an idle server connection.
        ClientKeepAlive|string|Enable client keep-alive for the service group. Possible values = YES, NO
        TcpBuffering|string|Enable TCP buffering for the service group. Possible values = YES, NO
        Compression|string|Enable compression for the service group. Possible values = YES, NO
        ...
        AppFlowLogging|string|Enable logging of AppFlow information for the specified service group. Default value: ENABLED. Possible values = ENABLED, DISABLED
...
+ Get
    * Properties  
        ...
        DuplicateWeight|double|weight of the monitor that is bound to servicegroup.
        RiseApbrStatusMessageCode|int|The code indicating the rise apbr status.
        ...
        NumberOfConnections|int|This will tell the number of client side connections are still open.
        ServiceConfigurationType|bool|The configuration type of the service group.
        Value|string|SSL Status. Possible values = Certkey not bound, SSL feature disabled
        ServerState|string|The state of the service. Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED
        ...
        StateUpdateReason|string|Checks state update reason on the secondary node.
        MonitoOwner|string|Tells the mon owner of the service.
        MonitorView|string|Tells the view id of the monitoring owner.
        ...
        NameServer|string|-
        DomainBasedServiceTtl|double|-
        ServiceItemActive|string|-
        ServiceItemBound|string|-
        ResponseTime|string|-
        MonitorUserStatusMessage|string|-
        Count|int|-
...
+ Update:
    * Properties:
        ...
        InjectClientIp|string|Insert the Client IP header in requests forwarded to the service. Possible values = ENABLED, DISABLED
        ClientIpHeader|string|Name of the HTTP header whose value must be set to the IP address of the client. Used with the Client IP parameter. If client IP insertion is enabled, and the client IP header is not specified, the value of Client IP Header parameter or the value set by the set ns config command is used as client's IP header name.
        UseSourceIp|string|Use client's IP address as the source IP address when initiating connection to the server. With the NO setting, which is the default, a mapped IP (MIP) address or subnet IP (SNIP) address is used as the source IP address to initiate server side connections.
        PathMonitor|string|Path monitoring for clustering.Possible values = YES, NO
        PathMonitorIndividual|string|Individual Path monitoring decisions. Possible values = YES, NO
        UseProxyPort|string|Use the proxy port as the source port when initiating connections with the server. With the NO setting, the client-side connection port is used as the source port for the server-side connection. Note: This parameter is available only when the Use Source IP (USIP) parameter is set to YES. Possible values = YES, NO
        HealthMonitor|string|Monitor the health of this service. Available settings function as follows:YES - Send probes to check the health of the service. NO - Do not send probes to check the health of the service. With the NO option, the appliance shows the service as UP at all times. Default value: YES. Possible values = YES, NO
        ...
        ClientKeepAlive|string|Enable client keep-alive for the service group. Possible values = YES, NO
        TcpBuffering|string|Enable TCP buffering for the service group. Possible values = YES, NO
        Compression|string|Enable compression for the specified service. Possible values = YES, NO
        MaxBandwidth|double|Maximum bandwidth, in Kbps, allocated for all the services in the service group.
        MonitorWeightThreshold|double|Minimum sum of weights of the monitors that are bound to this service. Used to determine whether to mark a service as UP or DOWN.
        DownStateFlush|string|Flush all active transactions associated with all the services in the service group whose state transitions from UP to DOWN. Do not enable this option for applications that must complete their transactions. Default value: ENABLED. Possible values = ENABLED, DISABLED
        TcpProfileName|string|Name of the TCP profile that contains TCP configuration settings for the service group.
...
+ Add:  
    * Properties:
        ...
        MonitorState|string|Monitor state. Possible values = ENABLED, DISABLED
