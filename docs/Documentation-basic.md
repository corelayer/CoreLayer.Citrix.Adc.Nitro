...
+ Get
    * Properties  
        ...
        MonitoringConnectionClose|string|Close monitoring connections by sending the service a connection termination message with the specified bit set. Default value: NONE. Possible values = RESET, FIN
        ...
        GlobalServerLoadBalancing|string|The GSLB option for the corresponding virtual server. Possible values = REMOTE, LOCAL
        ...
        ClMonitorView|string|Tells the mon owner of the service.
        ClMonitorOwner|string|Tells the view id of the monitoring owner.
...
+ Get
    * Properties  
        ...
        Cacheable|string|Use the transparent cache redirection virtual server to forward the request to the cache server. Note: Do not set this parameter if you set the Cache Type. Default value: NO. Possible values = YES, NO
        ClientIp|string|Insert the Client IP header in requests forwarded to the service. Possible values = ENABLED, DISABLED
        ...
        NetworkProfileName|string|Network profile for the service group.
        AutoScale|string|Auto scale option for a servicegroup. Default value: DISABLED. Possible values = DISABLED, DNS, POLICY
        MemberPort|int|member port.
        ...
        MonitorStatCode|int|The code indicating the monitor response.
        MonitorStatParam1|int|First parameter for use with message code.
        MonitorStatParam2|int|Second parameter for use with message code.
        MonitorStatParam3|int|Third parameter for use with message code.
        StateChangeTimeMSec|string|Time when last state change occurred. Milliseconds part.
        StateUpdateReason|string|Checks state update reason on the secondary node.
        ClMonitorOwner|string|Tells the mon owner of the service.
        ClMonitorView|string|Tells the view id of the monitoring owner.
